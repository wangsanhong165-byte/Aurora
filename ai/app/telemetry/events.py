...
STAGE_EVENTS = {
    ...
    "character.intent.sent": "character_intent_sent",
    "character.intent.received": "character_intent_received",
...
ERROR_CODES = {
    ...
    "character_intent_emit_failed": "Character intent emit failed",
...
STAGE_METADATA: dict[str, list[str]] = {
    ...
    "tool.result": ["tool_name", "risk", "status"],
    ...
    "character.intent.sent": ["emotion", "behavior"],
    "character.intent.received": ["emotion", "behavior"],
