...
Event sources place proactive opportunities here. The Runtime pipeline
decides whether to speak; event sources never call an LLM directly.
"""
...
# Global singleton
initiative_queue: InitiativeQueue = InitiativeQueue()
